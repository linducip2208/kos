...
class UtilityServiceTest extends TestCase
{
    ...
    public function test_record_reading_rejects_a_meter_reset_without_explicit_handling(): void
    {
        $room = Room::factory()->create();
        UtilityReading::factory()->create([
            'room_id' => $room->id,
        ...
        $this->service->recordReading($room->id, 'electricity', 99, now()->startOfMonth()->toDateString());
    }
