...
<header class="bg-white border-b border-slate-200 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <a href="https://wa.me/6281234567890" target="_blank" class="bg-green-500 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-green-600 transition-colors">WhatsApp</a>
    </div>
</header>
...
<div class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16 mt-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <h2 class="text-3xl font-extrabold mb-4">Butuh Aplikasi Manajemen Kos?</h2>
        <p class="text-blue-100 mb-8 max-w-2xl mx-auto">Source code aplikasi Kos Manager siap pakai. Fitur lengkap: booking, invoice, laporan keuangan, portal penghuni. Bisa dikustomisasi sesuai kebutuhan!</p>
        <a href="{{ route('pseo.beli') }}" class="inline-block bg-white text-primary-700 px-8 py-3 rounded-xl font-bold text-lg hover:bg-blue-50 transition-colors">Beli Source Code</a>
